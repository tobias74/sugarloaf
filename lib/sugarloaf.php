...
require_once(dirname(__FILE__).'/service/AbstractManagedService.php');
...
require_once(dirname(__FILE__).'/parameters/AbstractParameter.php');
require_once(dirname(__FILE__).'/parameters/UnmanagedParameter.php');
